# Generated by Django 4.2.11 on 2025-04-22 06:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0028_crorisinstitutions_parent'),
    ]

    operations = [
        migrations.CreateModel(
            name='Organization4APIKey',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_keys', to='backend.organization4apikey')),
            ],
            options={
