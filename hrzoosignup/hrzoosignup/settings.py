...
try:
    ...
    CRORIS_LEADINSTITUTESUBMITNATIONAL = config.getboolean('CRORIS', 'LeadInstituteSubmitNational')
    ...
    PORTFOLIO_API = config.get("PORTFOLIO", "API")
    PORTFOLIO_TOKEN = config.get("PORTFOLIO", "Token")
