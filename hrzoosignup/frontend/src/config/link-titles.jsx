...
export function LinkTitles(loc, locale='hr') {
    let url2linktitle = {
      ...
      'en': {
        ...
        [url_ui_prefix + '/new-request/research-project']: 'New request on behalf of research project',
        [url_ui_prefix + '/new-request/institutional-project']: 'New request on behalf of institutional project',
        [url_ui_prefix + '/new-request/internal-project']: 'New request on behalf of internal project',
        [url_ui_prefix + '/new-request/practical-class']: 'New request on behalf of practical class',
        [url_ui_prefix + '/new-request/thesis-project']: 'New request on behalf of thesis project',
        [url_ui_prefix + '/new-request/srce-workshop']: 'New request on behalf of Srce workshop',
        [url_ui_prefix + '/public-keys']: 'Public keys management',
        [url_ui_prefix + '/public-keys/new']: 'Add public key',
